...
> **Upgrading from before v0.1.21?** The daemon plist previously used a versioned path that broke after `brew reinstall`. Run `rmcal daemon uninstall && rmcal daemon install` once to fix it. From v0.1.21 onward this is handled automatically.
